...
README §1.4: "Note that the submission of the planned test cases must take place **by 12 o'clock**." Der Test-Plan ist in [`test-protocol.md`](../test-protocol.md) dokumentiert und wird vor 12:00 abgegeben (siehe Qualitätsziel Q3 in [Kapitel 1 §1.2](./01-introduction.md#12-qualitätsziele)).
