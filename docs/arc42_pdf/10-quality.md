<h1 id="chapter-10">10 Qualitätsanforderungen</h1>

> arc42 v8.2 · Skills Battle 2026 — Application Development — Killer Sudoku
> Quelldokument (autoritativ): **Aufgabenstellung**

Dieses Kapitel präzisiert die in [§1.2](#chapter-1) genannten Top-Ziele in Form eines Quality-Trees und konkreter, testbarer Quality-Szenarien.
...
| Q2 Lösungs-Eindeutigkeit | KO1 (Branch `Solutions ≥ 2`), siehe **V07** |
...
Jedes Szenario ist tabellarisch nach dem arc42-Schema **Quelle · Stimulus · Artefakt · Reaktion · Antwortmaß** beschrieben. Spalte "Test-Anker" verlinkt die geplanten Unit-/Integration-/E2E-Tests (siehe **Test-Protokoll**).
...
| Test-Anker | UC11 → AC11.1 (siehe use-cases.md UC11) |
...
| Test-Anker | Manueller UI-Test im **Test-Protokoll** |
...
| README-Beleg | §2.1 UC2 "login is required" + Sicherheits-Defaults nach **V15** |
...
| Test-Anker | Coverlet-Report als Submission-Artefakt; siehe Top-Ziel **Q3** in [§1.2](#chapter-1) |

---

## §10.3 Querverweise

- [Top-Ziele §1.2](#chapter-1) — drei priorisierte Ziele
- Validation V01–V16 — Detailregeln pro Layer (Client / Server / DB)
- Use Cases UC01–UC14 — Acceptance Criteria (AC) je UC
- **Test-Protokoll** — konkrete Test-Cases mit Erwartung
- [Kapitel 11 — Risiken](#chapter-11) — Risiken, die die Qualitätsziele bedrohen
